    ...
    <div className="bg-white text-neutral-900 font-sans">
      ...
      <section className="relative bg-blue-950 text-white py-36 text-center">
        <div className="max-w-4xl mx-auto px-6">
          <img src="/image001.png" alt="AM&V Logo" className="mx-auto w-60 mb-8" />
      ...
      <section id="partners" className="py-24 bg-gray-50 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="shadow-sm border border-neutral-200 p-6 rounded-xl">
            ...
            <div className="shadow-sm border border-neutral-200 p-6 rounded-xl text-center text-neutral-400">
